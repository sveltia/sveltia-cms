...
- Our [local repository workflow](#working-with-a-local-git-repository) does not require a proxy server. This reduces attack surfaces by eliminating the possibility of compromised dependencies[^158], unauthorized API access[^282] or an undisclosed vulnerability[^318] in the proxy server.
