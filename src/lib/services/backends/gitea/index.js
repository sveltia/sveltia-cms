...
import { commitChanges } from '$lib/services/backends/gitea/commits';
import {
  BACKEND_LABEL,
  BACKEND_NAME,
  DEFAULT_API_ROOT,
  DEFAULT_AUTH_PATH,
  DEFAULT_AUTH_ROOT,
} from '$lib/services/backends/gitea/constants';
import { fetchBlob, fetchFiles } from '$lib/services/backends/gitea/files';
import { repository, getBaseURLs } from '$lib/services/backends/gitea/repository';
import { apiConfig } from '$lib/services/backends/shared/api';
