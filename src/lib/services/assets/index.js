 ...
 * @param {object} [options] Options.
 * @param {import('$lib/typedefs').Entry} [options.entry] Associated entry to be used to help locate
 ...
 * @param {import('$lib/typedefs').Entry} [entry] Associated entry to be used to help locate an
