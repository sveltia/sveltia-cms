...
export const strings = {
  ...
  "sign_in_with_mobile_instruction": "Scan the QR code below with your phone or tablet for passwordless sign-in. Your settings will be automatically copied.",
  ...
  "sign_in_using_pat_description": "Enter your token below. It must have read/write access to the repository content.",
  ...
  "work_with_local_repo_description": "Once prompted, select the root directory of the “{repo}” repository.",
  "work_with_local_repo_description_no_repo": "Once prompted, select the root directory of your Git repository.",
  "work_with_test_repo": "Work with Test Repository",
  "sign_in_error": {
    "not_project_root": "The folder you have selected is not a repository root directory. Please try again.",
  ...
  "entry_parse_error": "There was an error while parsing an entry file. Check the browser console for details.",
  "entry_parse_errors": "There were errors while parsing entry files. Check the browser console for details.",
  ...
  "backend_status": {
    "minor_incident": "{service} is experiencing a minor incident. Your workflow may be potentially affected.",
    "major_incident": "{service} is experiencing a major incident. You may want to wait until the situation has improved."
  },
  ...
  "viewing_x_collection_many_entries": "You’re now viewing the “{collection}” collection, which has {count} entries.",
  "viewing_x_collection_one_entry": "You’re now viewing the “{collection}” collection, which has one entry.",
  "viewing_x_collection_no_entries": "You’re now viewing the “{collection}” collection, which has no entries yet.",
  "viewing_x_asset_folder_many_assets": "You’re now viewing the “{folder}” asset folder, which has {count} assets.",
  "viewing_x_asset_folder_one_asset": "You’re now viewing the “{folder}” asset folder, which has one asset.",
  "viewing_x_asset_folder_no_assets": "You’re now viewing the “{folder}” asset folder, which has no assets yet.",
  ...
  "creating_entries_disabled_by_admin": "Creating new entries in this collection is disabled by the administrator.",
  "creating_entries_disabled_by_limit": "You cannot add new entries to this collection because it has reached its limit of {limit} entries.",
  ...
  "viewing_entry_search_results": "You’re now viewing search results for “{terms}”. We’ve found {entries}.",
  "viewing_asset_search_results": "You’re now viewing search results for “{terms}”. We’ve found {assets}.",
  ...
  "enter_new_name_for_asset_with_one_entry": "Enter a new name below. An entry using the asset will also be updated.",
  "enter_new_name_for_asset_with_many_entries": "Enter a new name below. {count} entries using the asset will also be updated.",
  ...
  "dropped_image_type_mismatch": "The dropped file is not supported. Only an AVIF, GIF, JPEG, PNG, WebP or SVG image is accepted. Please try again.",
  ...
  "confirm_deleting_this_entry_with_assets": "Are you sure to delete this entry and associated assets?",
  "confirm_deleting_selected_entry": "Are you sure to delete the selected entry?",
  "confirm_deleting_selected_entry_with_assets": "Are you sure to delete the selected entry and associated assets?",
  "confirm_deleting_selected_entries": "Are you sure to delete the selected {count} entries?",
  "confirm_deleting_selected_entries_with_assets": "Are you sure to delete the selected {count} entries and associated assets?",
  "confirm_deleting_all_entries": "Are you sure to delete all the entries?",
  "confirm_deleting_all_entries_with_assets": "Are you sure to delete all the entries and associated assets?",
  ...
  "confirm_uploading_files": "Are you sure to save the following {count} files to the “{folder}” folder?",
  "oversized_files": "Oversized Files",
  "warning_oversized_file": "This file cannot be uploaded because it exceeds the maximum size of {size}. Please reduce the size or select a different file.",
  "warning_oversized_files": "These files cannot be uploaded because they exceed the maximum size of {size}. Please reduce the sizes or select different files.",
  ...
  "restore_backup_description": "This entry has a backup from {datetime}. Do you want to restore the edited draft?",
  ...
  "edit_entry_announcement": "You’re now editing the “{entry}” entry in the “{collection}” collection.",
  ...
  "locale_x_now_disabled": "The {locale} content is now disabled. It will be deleted when you save the entry.",
  ...
  "edit_slug": "Edit Slug",
  "edit_slug_warning": "Changing the slug may break internal and external links to the entry. Currently, Sveltia CMS does not update references created with the Relation widget, so you’ll need to manually update such references along with other links.",
  "edit_slug_error": {
  ...
  "assets_dialog": {
    ...
    "error": {
      ...
      "image_fetch_failed": "There was an error while downloading the selected asset. Please try again later."
    },
  ...
  "cloud_storage": {
    ...
    "cloudinary": {
      "auth": {
        "initial": "Enter you API Secret to use Cloudinary.",
        "requested": "Validating…",
  ...
  "config": {
    "error": {
      ...
      "parse_failed_unsupported_type": "The configuration file is not a valid file type. Only YAML and JSON are supported.",
      ...
      "invalid_repository": "The configured repository is invalid. It must be in “owner/repo” format.",
      ...
      "public_folder_relative_path": "The configured public folder is invalid. It must be an absolute path starting with “/”.",
  ...
  "local_backend": {
    "unsupported_browser": "Local development is not supported in your browser. Please use Chrome or Edge instead.",
  ...
  "prefs": {
    ...
    "error": {
      "permission_denied": "Browser storage (Cookie) access has been denied. Please check the permission and try again."
    },
    "appearance": {
      "title": "Appearance",
      "theme": "Theme",
    ...
    "i18n": {
      ...
      "translator": {
        ...
        "description": "Sign up for <a {homeHref}>{service}</a> and enter <a {apiKeyHref}>your API Key</a> here to enable quick translation of text entry fields."
      }
    },
    "media": {
      "title": "Media",
      "stock_photos": {
        ...
        "description": "Sign up for <a {homeHref}>{service} API</a> and enter <a {apiKeyHref}>your API Key</a> here to insert free stock photos to image entry fields.",
    ...
    "advanced": {
      ...
      "developer_mode": {
        ...
        "description": "Enable some developer-oriented features, including detailed console logs and native context menus.",
        "switch_label": "Enable Developer Mode"
      },
      "deploy_hook": {
        "title": "Deploy Hook",
        "description": "Enter a webhook URL to be called when you manually trigger a deployment by selecting Publish Changes. This can be left blank if you’re using GitHub Actions.",
