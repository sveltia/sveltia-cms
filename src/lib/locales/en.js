export const strings = {
  ...
  upload: 'Upload',
  upload_and_publish: 'Upload & Publish',
  copy: 'Copy',
  download: 'Download',
  delete: 'Delete',
  duplicate: 'Duplicate',
  ...
  confirm_deleting_selected_file: 'Are you sure to delete the selected file?',
  confirm_deleting_selected_files: 'Are you sure to delete the selected {number} files?',
  confirm_deleting_all_files: 'Are you sure to delete all the files?',
  ...
  confirm_deleting_selected_entries: 'Are you sure to delete the selected {number} entries?',
  ...
  confirm_uploading_files:
    'Are you sure to save the following {number} files to the {folder} folder?',
